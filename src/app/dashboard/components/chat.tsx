...
const Chat: React.FC<ChatProps> = ({ children }) => {
  ...
  //saving the chat messages to local storage
  useEffect(() => {
      ...
      await llamaService.generateResponse(sessionId, input, (data: string) => {
        setMessages((prevMessages) => {
          ...
          if (lastMessage && lastMessage.startsWith("Clara:")) {
            return [...prevMessages.slice(0, -1), `${lastMessage}${data}`];
          }
            ...
            <div
              ...
              className={`p-2 rounded-lg flex ${
                message.startsWith("You:")
                  ? "bg-blue-300 text-gray-700 self-end"
